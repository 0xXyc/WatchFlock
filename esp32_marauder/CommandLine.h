...
const char PROGMEM SNIFF_FLOCK_WIFI_CMD[] = "sniffflockwifi";
const char PROGMEM SNIFF_FLOCK_BLE_CMD[]  = "sniffflockble";
...
const char PROGMEM HELP_SNIFF_FLOCK_WIFI_CMD[] = "sniffflockwifi";
const char PROGMEM HELP_SNIFF_FLOCK_BLE_CMD[]  = "sniffflockble";
